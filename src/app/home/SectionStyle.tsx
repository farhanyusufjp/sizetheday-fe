...
import woman from '@/images/soraphoto.png';
        ...
        <div className='items-stretch gap-5 md:flex'>
          ...
          <div className='basis-3/5'>
            ...
            <div className='space-y-5 rounded-2xl bg-primary p-5 text-white'>
              ...
              <span className='text-3xl font-medium text-secondary'>#Festival</span>
            </div>
          </div>
        </div>
        ...
        <div className='space-y-10 md:pt-40 lg:pt-0'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div className='space-y-5'>
              ...
              <p className='text-lg font-medium text-primary'>- {promoSection.review.reviewer}</p>
            </div>
          </div>
        </div>
      </div>
